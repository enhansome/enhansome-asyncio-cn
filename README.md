...
[Awesome-asyncio](https://github.com/timofurrer/awesome-asyncio) ⭐ 5,131 | 🐛 19 | 📅 2025-12-01 是 [Timo Furrer](https://github.com/timofurrer) 发起并维护的 Python Asyncio 资源列表。我觉得这个是很赞的想法，所以维护了一个中文版本的，在这里，收集了大量的 [Asyncio](https://docs.python.org/3/library/asyncio.html) 的最棒、最新的资源，供大家探索 Python 异步编程世界。
...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,636 | 🐛 151 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,555 | 🐛 228 | 🌐 Python | 📅 2026-09-21 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,976 | 🐛 100 | 🌐 Python | 📅 2026-09-21 - 轻量级的，快速的 ASGI 服务器。
...
* [autobahn](https://github.com/crossbario/autobahn-python) ⭐ 2,542 | 🐛 191 | 🌐 Python | 📅 2026-07-15 - 支持 Asyncio 与 Twisted 的 WebSocket 及 WAMP，用于客户端与服务端。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 296 | 🌐 Python | 📅 2026-09-21 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,789 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 296 | 🌐 Python | 📅 2026-09-21 方言的轻量级 Python 异步 ORM。
* [motor](https://github.com/mongodb/motor) ⭐ 2,526 | 🐛 2 | 🌐 Python | 📅 2026-09-21 - 访问 MongoDB 数据库的异步驱动。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 762 | 🐛 4 | 🌐 Python | 📅 2026-09-21 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,988 | 🐛 1 | 🌐 Python | 📅 2026-09-19 和 aiopg 实现的 ORM。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,333 | 🐛 240 | 🌐 Python | 📅 2026-09-21 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,434 | 🐛 371 | 🌐 Python | 📅 2026-09-21 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,896 | 🐛 162 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
* [trio](https://github.com/python-trio/trio) ⭐ 7,333 | 🐛 330 | 🌐 Python | 📅 2026-09-21 - 人性化的，Pythonic 的异步 IO 库。
