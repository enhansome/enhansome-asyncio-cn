...
[Awesome-asyncio](https://github.com/timofurrer/awesome-asyncio) ⭐ 5,124 | 🐛 22 | 📅 2025-12-01 是 [Timo Furrer](https://github.com/timofurrer) 发起并维护的 Python Asyncio 资源列表。我觉得这个是很赞的想法，所以维护了一个中文版本的，在这里，收集了大量的 [Asyncio](https://docs.python.org/3/library/asyncio.html) 的最棒、最新的资源，供大家探索 Python 异步编程世界。
...
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,535 | 🐛 230 | 🌐 Python | 📅 2026-08-29 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,934 | 🐛 85 | 🌐 Python | 📅 2026-08-30 - 轻量级的，快速的 ASGI 服务器。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,078 | 🐛 300 | 🌐 Python | 📅 2026-02-27 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,792 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,078 | 🐛 300 | 🌐 Python | 📅 2026-02-27 方言的轻量级 Python 异步 ORM。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,265 | 🐛 234 | 🌐 Python | 📅 2026-08-25 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,109 | 🐛 448 | 🌐 Python | 📅 2026-08-28 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,659 | 🐛 52 | 🌐 Python | 📅 2026-08-26 - 支持 Asyncio 的 Pytest 库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,894 | 🐛 157 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
...
* [faust](https://github.com/robinhood/faust) ⭐ 6,826 | 🐛 280 | 🌐 Python | 📅 2024-07-27 - 纯 Python 的流处理库，用于处理流数据和事件。
* [aiofiles](https://github.com/Tinche/aiofiles/) ⭐ 3,255 | 🐛 57 | 🌐 Python | 📅 2026-08-29 - 基于 Asyncio，支持文件异步操作。
