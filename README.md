...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,638 | 🐛 148 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,548 | 🐛 219 | 🌐 Python | 📅 2026-09-11 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,959 | 🐛 89 | 🌐 Python | 📅 2026-09-12 - 轻量级的，快速的 ASGI 服务器。
* [Japronto!](https://github.com/squeaky-pl/japronto) ⭐ 8,529 | 🐛 89 | 🌐 C | 📅 2023-08-14 - 基于 uvloop 和 picohttpparse 构建的实验性 HTTP 工具箱。
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,716 | 🐛 5 | 🌐 Python | 📅 2026-09-12 - Python 构建的 WebSocket 客户端/服务端的库，致力于简洁、正确地编写代码。
...
* [crossbar](https://github.com/crossbario/crossbar) ⭐ 2,064 | 🐛 305 | 🌐 Python | 📅 2026-09-07 - Crossbar.io 是提供分布式和微服务应用的网络平台。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 306 | 🌐 Python | 📅 2026-02-27 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,087 | 🐛 306 | 🌐 Python | 📅 2026-02-27 方言的轻量级 Python 异步 ORM。
* [motor](https://github.com/mongodb/motor) ⭐ 2,525 | 🐛 2 | 🌐 Python | 📅 2026-09-07 - 访问 MongoDB 数据库的异步驱动。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 4 | 🌐 Python | 📅 2026-09-09 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,985 | 🐛 0 | 🌐 Python | 📅 2026-09-08 和 aiopg 实现的 ORM。
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,716 | 🐛 5 | 🌐 Python | 📅 2026-09-12 构建于 Asyncio 之上的异步 websockets 库。
* [AsyncSSH](https://github.com/ronf/asyncssh) ⭐ 1,757 | 🐛 15 | 🌐 Python | 📅 2026-09-12 - 提供执行 SSHv2 协议的异步客户端/服务端。
* [aiodns](https://github.com/saghul/aiodns) ⭐ 592 | 🐛 15 | 🌐 Python | 📅 2026-08-18 - 简单的 Asyncio DNS 服务解析器。
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,302 | 🐛 237 | 🌐 Python | 📅 2026-09-07 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,300 | 🐛 393 | 🌐 Python | 📅 2026-09-10 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,662 | 🐛 50 | 🌐 Python | 📅 2026-09-09 - 支持 Asyncio 的 Pytest 库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,899 | 🐛 160 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
* [trio](https://github.com/python-trio/trio) ⭐ 7,322 | 🐛 326 | 🌐 Python | 📅 2026-09-07 - 人性化的，Pythonic 的异步 IO 库。
