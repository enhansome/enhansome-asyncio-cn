...
[Awesome-asyncio](https://github.com/timofurrer/awesome-asyncio) ⭐ 5,121 | 🐛 22 | 📅 2025-12-01 是 [Timo Furrer](https://github.com/timofurrer) 发起并维护的 Python Asyncio 资源列表。我觉得这个是很赞的想法，所以维护了一个中文版本的，在这里，收集了大量的 [Asyncio](https://docs.python.org/3/library/asyncio.html) 的最棒、最新的资源，供大家探索 Python 异步编程世界。
...
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,535 | 🐛 228 | 🌐 Python | 📅 2026-08-29 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,934 | 🐛 87 | 🌐 Python | 📅 2026-08-29 - 轻量级的，快速的 ASGI 服务器。
* [Japronto!](https://github.com/squeaky-pl/japronto) ⭐ 8,530 | 🐛 91 | 🌐 C | 📅 2023-08-14 - 基于 uvloop 和 picohttpparse 构建的实验性 HTTP 工具箱。
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,715 | 🐛 1 | 🌐 Python | 📅 2026-08-29 - Python 构建的 WebSocket 客户端/服务端的库，致力于简洁、正确地编写代码。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 3 | 🌐 Python | 📅 2026-08-28 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,985 | 🐛 0 | 🌐 Python | 📅 2026-08-29 和 aiopg 实现的 ORM。
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,715 | 🐛 1 | 🌐 Python | 📅 2026-08-29 构建于 Asyncio 之上的异步 websockets 库。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,263 | 🐛 234 | 🌐 Python | 📅 2026-08-25 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,096 | 🐛 448 | 🌐 Python | 📅 2026-08-28 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,894 | 🐛 156 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
