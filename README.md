...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,641 | 🐛 148 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,542 | 🐛 216 | 🌐 Python | 📅 2026-09-08 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,952 | 🐛 90 | 🌐 Python | 📅 2026-09-01 - 轻量级的，快速的 ASGI 服务器。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,084 | 🐛 304 | 🌐 Python | 📅 2026-02-27 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,084 | 🐛 304 | 🌐 Python | 📅 2026-02-27 方言的轻量级 Python 异步 ORM。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-09-08 和 aiopg 实现的 ORM。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,290 | 🐛 237 | 🌐 Python | 📅 2026-09-07 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,244 | 🐛 400 | 🌐 Python | 📅 2026-09-08 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,662 | 🐛 52 | 🌐 Python | 📅 2026-09-07 - 支持 Asyncio 的 Pytest 库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,897 | 🐛 159 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
* [trio](https://github.com/python-trio/trio) ⭐ 7,316 | 🐛 323 | 🌐 Python | 📅 2026-09-07 - 人性化的，Pythonic 的异步 IO 库。
...
* [aiofiles](https://github.com/Tinche/aiofiles/) ⭐ 3,257 | 🐛 58 | 🌐 Python | 📅 2026-08-29 - 基于 Asyncio，支持文件异步操作。
