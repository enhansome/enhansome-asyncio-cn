...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,639 | 🐛 149 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,549 | 🐛 220 | 🌐 Python | 📅 2026-09-17 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,973 | 🐛 97 | 🌐 Python | 📅 2026-09-16 - 轻量级的，快速的 ASGI 服务器。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 308 | 🌐 Python | 📅 2026-02-27 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 308 | 🌐 Python | 📅 2026-02-27 方言的轻量级 Python 异步 ORM。
* [motor](https://github.com/mongodb/motor) ⭐ 2,525 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - 访问 MongoDB 数据库的异步驱动。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 762 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,989 | 🐛 0 | 🌐 Python | 📅 2026-09-14 和 aiopg 实现的 ORM。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,322 | 🐛 239 | 🌐 Python | 📅 2026-09-07 接口相似的异步 HTTP 库。
* [aioftp](https://github.com/aio-libs/aioftp) ⭐ 211 | 🐛 28 | 🌐 Python | 📅 2026-08-11 - 基于 Asyncio 的 ftp 服务。

## 爬虫

*应用于网络爬虫的库*

* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,396 | 🐛 370 | 🌐 Python | 📅 2026-09-18 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,663 | 🐛 50 | 🌐 Python | 📅 2026-09-17 - 支持 Asyncio 的 Pytest 库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,895 | 🐛 161 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
* [trio](https://github.com/python-trio/trio) ⭐ 7,331 | 🐛 328 | 🌐 Python | 📅 2026-09-17 - 人性化的，Pythonic 的异步 IO 库。
