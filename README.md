...
[Awesome-asyncio](https://github.com/timofurrer/awesome-asyncio) ⭐ 5,130 | 🐛 19 | 📅 2025-12-01 是 [Timo Furrer](https://github.com/timofurrer) 发起并维护的 Python Asyncio 资源列表。我觉得这个是很赞的想法，所以维护了一个中文版本的，在这里，收集了大量的 [Asyncio](https://docs.python.org/3/library/asyncio.html) 的最棒、最新的资源，供大家探索 Python 异步编程世界。
...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,639 | 🐛 150 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,553 | 🐛 222 | 🌐 Python | 📅 2026-09-19 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,973 | 🐛 95 | 🌐 Python | 📅 2026-09-19 - 轻量级的，快速的 ASGI 服务器。
* [Japronto!](https://github.com/squeaky-pl/japronto) ⭐ 8,528 | 🐛 89 | 🌐 C | 📅 2023-08-14 - 基于 uvloop 和 picohttpparse 构建的实验性 HTTP 工具箱。
* [websockets](https://github.com/aaugustin/websockets/) ⭐ 5,718 | 🐛 7 | 🌐 Python | 📅 2026-09-19 - Python 构建的 WebSocket 客户端/服务端的库，致力于简洁、正确地编写代码。
...
* [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 309 | 🌐 Python | 📅 2026-09-19 - 快速访问 PostgreSQL 数据库客户端的异步驱动。
* [GINO](https://github.com/fantix/gino) ⭐ 2,790 | 🐛 54 | 🌐 Python | 📅 2022-02-12 - 基于 [SQLAlchemy](https://www.sqlalchemy.org/) Core 和 [asyncpg](https://github.com/MagicStack/asyncpg) ⭐ 8,093 | 🐛 309 | 🌐 Python | 📅 2026-09-19 方言的轻量级 Python 异步 ORM。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 762 | 🐛 4 | 🌐 Python | 📅 2026-09-14 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,991 | 🐛 1 | 🌐 Python | 📅 2026-09-19 和 aiopg 实现的 ORM。
...
* [websockets](https://github.com/aaugustin/websockets) ⭐ 5,718 | 🐛 7 | 🌐 Python | 📅 2026-09-19 构建于 Asyncio 之上的异步 websockets 库。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,329 | 🐛 239 | 🌐 Python | 📅 2026-09-07 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,407 | 🐛 371 | 🌐 Python | 📅 2026-09-18 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [trio](https://github.com/python-trio/trio) ⭐ 7,332 | 🐛 330 | 🌐 Python | 📅 2026-09-17 - 人性化的，Pythonic 的异步 IO 库。
...
* [aiofiles](https://github.com/Tinche/aiofiles/) ⭐ 3,260 | 🐛 60 | 🌐 Python | 📅 2026-08-29 - 基于 Asyncio，支持文件异步操作。
