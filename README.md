...
* [sanic](https://github.com/channelcat/sanic) ⭐ 18,647 | 🐛 146 | 🌐 Python | 📅 2026-07-29 - Python 3.5+ Web 服务器，主打速度与性能。
* [aiohttp](https://github.com/KeepSafe/aiohttp) ⭐ 16,535 | 🐛 231 | 🌐 Python | 📅 2026-08-31 - 支持 Asyncio (PEP-3156) 的 HTTP 客户端/服务端网络库。
* [uvicorn](https://github.com/encode/uvicorn) ⭐ 10,939 | 🐛 85 | 🌐 Python | 📅 2026-08-30 - 轻量级的，快速的 ASGI 服务器。
...
* [crossbar](https://github.com/crossbario/crossbar) ⭐ 2,064 | 🐛 305 | 🌐 Python | 📅 2026-08-31 - Crossbar.io 是提供分布式和微服务应用的网络平台。
...
* [peewee-async](https://github.com/05bit/peewee-async) ⭐ 763 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - 基于 [peewee](https://github.com/coleifer/peewee) ⭐ 11,986 | 🐛 0 | 🌐 Python | 📅 2026-08-29 和 aiopg 实现的 ORM。
...
* [asks](https://github.com/theelous3/asks) ⭐ 512 | 🐛 39 | 🌐 Python | 📅 2022-05-17 - 与 [requests](https://github.com/requests/requests) ⭐ 54,269 | 🐛 235 | 🌐 Python | 📅 2026-08-31 接口相似的异步 HTTP 库。
...
* [Scrapy](https://github.com/scrapy/scrapy) ⭐ 64,142 | 🐛 448 | 🌐 Python | 📅 2026-08-28 - 一个为了爬取网站数据，提取结构性数据而编写的应用框架。
...
* [pytest-asyncio](https://github.com/pytest-dev/pytest-asyncio) ⭐ 1,659 | 🐛 50 | 🌐 Python | 📅 2026-08-31 - 支持 Asyncio 的 Pytest 库。
...
* [uvloop](https://github.com/MagicStack/uvloop) ⭐ 11,895 | 🐛 157 | 🌐 Cython | 📅 2026-07-14 - 基于 libuv 实现的 Asyncio 事件循环库。
* [trio](https://github.com/python-trio/trio) ⭐ 7,309 | 🐛 323 | 🌐 Python | 📅 2026-08-27 - 人性化的，Pythonic 的异步 IO 库。
